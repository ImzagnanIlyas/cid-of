...
@section('content')
    <div class="row">
        ...
        <div class="card">
            ...
            <div>
                <div class="text-value-sm text-success">+3</div>
    ...
    <div class="row">
        ...
        <div class="card text-white bg-primary">
            ...
            <div class="text-value">100</div><small class="text-muted text-uppercase font-weight-bold">Les commandes</small>
            <div class="progress progress-white progress-xs mt-3">
                <div class="progress-bar" role="progressbar" style="width: 100%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
            <div class="row mt-2">
                <div class="col-md-6 text-center">
                    <div class="text-value">385</div><small class="text-muted text-uppercase font-weight-bold">ODFs</small>
                    <div class="progress progress-white progress-xs mt-3">
                        <div class="progress-bar" role="progressbar" style="width: 75%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
                <div class="col-md-6 text-center">
                    <div class="text-value">385</div><small class="text-muted text-uppercase font-weight-bold">FAEs</small>
                    <div class="progress progress-white progress-xs mt-3">
        ...
        <div class="card text-white bg-warning">
            ...
            <div class="text-value">6</div><small class="text-muted text-uppercase font-weight-bold">En cours</small>
            <div class="progress progress-white progress-xs mt-3">
        ...
        <div class="card text-white bg-success">
            ...
            <div class="text-value">90</div><small class="text-muted text-uppercase font-weight-bold">Acceptés</small>
            <div class="progress progress-white progress-xs mt-3">
        ...
        <div class="card text-white bg-danger">
            ...
            <div class="text-value">4</div><small class="text-muted text-uppercase font-weight-bold">Refusés</small>
            <div class="progress progress-white progress-xs mt-3">
                <div class="progress-bar" role="progressbar" style="width: 20%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
            <div class="row mt-2">
